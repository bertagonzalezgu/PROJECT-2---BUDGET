...
export default function BudgetDetail({budget}: BudgetDetailProps){
    ...
    return (
        <div className="max-w-3xl mx-auto my-8 p-5 font-[Montserrat]">
            ...
            <div className="bg-white rounded-3xl shadow-md p-8 border border-gray-300 space-y-8">
                ...
                <div>
                    ...
                    <ul className="divide-y divide-blue-200 border-blue-200 border rounded-2xl overflow-hidden p-4">
                        {servicesWithPrice.map((service) => (
                            <li key={service.name} className="flex justify-between items-center p-2 bg-white hover:bg-slate-50/50 transition-colors">
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-100 bg-linear-to-bl from-white to-blue-50/30 -mx-8 -mb-8 p-8 rounded-b-3xl">
